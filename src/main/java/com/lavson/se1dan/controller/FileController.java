...
import com.lavson.se1dan.constant.FileConstant;
import com.lavson.se1dan.exception.BusinessException;
import com.lavson.se1dan.manager.CosManager;
import com.lavson.se1dan.model.dto.file.UploadFileRequest;
import com.lavson.se1dan.model.entity.User;
import com.lavson.se1dan.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        try {
            ...
            // 返回可访问地址
            return ResultUtils.success(cosManager.getHost() + filepath);
        } catch (Exception e) {
