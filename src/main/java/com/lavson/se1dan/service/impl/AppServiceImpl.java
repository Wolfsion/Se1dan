...
import com.lavson.se1dan.model.enums.ScoringStrategyEnum;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            AppTypeEnum ate = AppTypeEnum.getEnumByValue(appType);
            ThrowUtils.throwIf(ate == null, ErrorCode.PARAMS_ERROR, "应用类型非法");
            ScoringStrategyEnum sse = ScoringStrategyEnum.getEnumByValue(scoringStrategy);
            ThrowUtils.throwIf(sse == null, ErrorCode.PARAMS_ERROR, "应用评分策略非法");
        }
        // 修改数据时，有参数则校验
        ...
        if (reviewStatus != null) {
            ReviewStatusEnum rse = ReviewStatusEnum.getEnumByValue(reviewStatus);
            ThrowUtils.throwIf(rse == null, ErrorCode.PARAMS_ERROR, "审核状态非法");
        }
    }
